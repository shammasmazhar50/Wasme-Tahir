      ...
      <div className="container">
        <section className="mk-header">
          ...
          <motion.div className="mk-header-img" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2, duration: 1 }}>
             <img src="/images/7E924B31-AAB3-41E3-B6B0-24E65BFABF81.png" alt="Wasme Tahir" />
          </motion.div>
        </section>
        ...
        <section className="mk-stats-grid">
          <motion.div className="mk-stat-box dark" {...fadeUp}>
            ...
            <h2 className="heading-lg">258K+</h2>
            <p>Across all platforms</p>
          </motion.div>
          <motion.div className="mk-stat-box" {...fadeUp} transition={{ delay: 0.1 }}>
            <span className="subheading">INSTAGRAM</span>
            <h2 className="heading-md">139K+</h2>
            <p>Followers</p>
          </motion.div>
          <motion.div className="mk-stat-box" {...fadeUp} transition={{ delay: 0.2 }}>
            <span className="subheading">TIKTOK</span>
            <h2 className="heading-md">119K+</h2>
            <p>Followers</p>
          </motion.div>
        </section>
        ...
        <section className="mk-audience">
          ...
          <div className="audience-grid">
            ...
            <motion.div className="audience-card" {...fadeUp} transition={{ delay: 0.1 }}>
              <h4>Age</h4>
              <div className="demo-bar"><div className="demo-fill" style={{ width: '65%' }}></div></div>
              <p>65% 25-34 Years Old</p>
            </motion.div>
            <motion.div className="audience-card" {...fadeUp} transition={{ delay: 0.2 }}>
              <h4>Top Locations</h4>
